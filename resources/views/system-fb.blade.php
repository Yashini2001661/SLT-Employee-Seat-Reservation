...
<head>
    ...
    <title>Facebook Seat Booking</title>
...
<body>
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="container text-center">
            ...
            <div id="custom-confirm" class="alert alert-primary text-center" style="display: none;">
                <p>Booking is not allowed for Facebook login users. Do you want to log in with your user account to book a seat?</p>
    ...
    document.getElementById('confirm-no').addEventListener('click', function() {
        ...
        customAlert.innerHTML = 'You will remain logged in with Facebook. Booking will not proceed.';
